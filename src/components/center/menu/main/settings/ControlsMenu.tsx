 ...
 * Controls Menu
 */
let newKey: Nullable<number>;
let currCell: Nullable<{ id: number; }>;
let tempKey: number;
		...
		<tr>
			...
			<td
				...
				onClick={() => {
					...
					tempKey = binds[id];
					setTxt("Press key");
					currCell = ref.current as typeof currCell;
				}}
			>
				{txt}
			</td>
...
export const { button: ControlsMenuBtn, menu: ControlsMenu, id: CONTROLS_MENU_ID } = createMenu({
